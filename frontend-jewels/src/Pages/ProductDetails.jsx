...
//         <svg
//           className={`w-5 h-5 transform transition-transform ${openAccordion === id ? "rotate-180" : ""
//             }`}
//           fill="none"
//           stroke="currentColor"
//           viewBox="0 0 24 24"
...
//       </button>
//       <div
//         className={`overflow-hidden transition-all duration-300 ${openAccordion === id ? "max-h-96" : "max-h-0"
//           }`}
//       >
...
//                 className={`aspect-square overflow-hidden rounded-lg border-2 ${activeImage === index
//                   ? "border-primary"
//                   : "border-transparent"
//                   }`}
//               >
...
//                     setActiveImage(0);
//                   }}
//                   className={`p-1 rounded-full border-2 ${selectedVariation === variation
//                     ? "border-primary"
//                     : "border-gray-200"
//                     }`}
//                 >
//                   <div
//                     className={`w-8 h-8 rounded-full ${variation === "rose-gold"
//                       ? "bg-rose-gold"
